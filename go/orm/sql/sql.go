...
var _ zoteorm.Repository = &Repository{}
var _ Connection = zotesql.NewConnection(nil, zotesql.NewDriver("_"))
...
func (r Repository) Find(ctx context.Context, models any, opts zoteorm.FindOptions) error {
	return nil
}

func (r Repository) Get(ctx context.Context, model any, opts zoteorm.GetOptions) error {
	return nil
}
