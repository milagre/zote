module github.com/milagre/zote/pulumi

go 1.25.11

require (
	github.com/milagre/zote/go v0.0.0-00010101000000-000000000000
	github.com/pulumi/pulumi-digitalocean/sdk/v4 v4.73.0
	...
	github.com/pulumiverse/pulumi-grafana/sdk v1.0.0
	gopkg.in/yaml.v3 v3.0.1
)

replace github.com/milagre/zote/go => ../go
